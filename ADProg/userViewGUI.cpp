 ...
 *              the child class, will edit or view the user records from the
 * ADPROG data structures. Environment: Windows 7, x64 build Built in QtCreator
 * compiler. Notes: NONE Revisions: 0.0, Initial Release
 *
